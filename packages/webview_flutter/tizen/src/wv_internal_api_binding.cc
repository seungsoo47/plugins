...
bool WvInternalApiBinding::Initialize() {
  ...
  view.ScrollBy = reinterpret_cast<WvViewScrollByFnPtr>(
      dlsym(handle_, "wv_view_scroll_by"));
  ...
  view.JavaScriptMessageHandlerAdd =
      reinterpret_cast<WvViewJavaScriptMessageHandlerAddFnPtr>(
          dlsym(handle_, "wv_view_javascript_message_handler_add"));
  ...
  context.WebStorageDeleteAll =
      reinterpret_cast<WvContextWebStorageDeleteAllFnPtr>(
          dlsym(handle_, "wv_context_web_storage_delete_all"));
  ...
  policy_decision.ResponseStatusCodeGet =
      reinterpret_cast<WvPolicyDecisionResponseStatusCodeGetFnPtr>(
  ...
  initialize_result_ =
      ...
      view.TitleGet && view.UserAgentSet && view.UserAgentGet &&
      view.ScrollSet && view.ScrollBy && view.ScrollPosGet &&
      view.ScriptExecute && view.BgColorSet && view.ContextGet &&
      view.SettingsGet && view.FeedTouchEvent && view.FeedMouseDown &&
      view.FeedMouseUp && view.FeedMouseMove && view.FeedMouseWheel &&
      view.SendKeyEvent && view.TouchEventsEnabledSet &&
      ...
      view.JavaScriptMessageHandlerAdd && view.SetSupportVideoHole &&
      view.MainFrameScrollbarVisibleSet && context.CookieManagerGet &&
      context.CacheModelSet && context.WebStorageDeleteAll &&
      context.CacheClear && cookie_manager.AcceptPolicySet &&
      cookie_manager.CookiesClear && settings.JavaScriptEnabledSet &&
      settings.ImePanelEnabledSet && settings.ForceZoomSet && error.CodeGet &&
